...
def addr(s: str) -> Address:
    """Helper to cast string to Address for type checking."""
    return Address(cast(ChecksumAddress, s))
...
CHAINS: dict[str, ChainConfig] = {
    "ethereum": ChainConfig(
        ...
        uniswap_v2_router=addr("0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"),
        uniswap_v2_factory=addr("0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f"),
        uniswap_v3_router=addr("0xE592427A0AEce92De3Edee1F18E0157C05861564"),
        uniswap_v3_factory=addr("0x1F98431c8aD98523631AE4a59f267346ea31F984"),
        uniswap_v3_quoter=addr("0x61fFE014bA17989E743c5F6cB21bF9697530B21e"),
        aave_v3_pool=addr("0x87870Bca3F3fD6335C3F4ce8392D69350B4fA4E2"),
        usdc=addr("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"),
        usdt=addr("0xdAC17F958D2ee523a2206206994597C13D831ec7"),
        dai=addr("0x6B175474E89094C44Da98b954EedeC8992F8dC2"),
    ),
    "arbitrum": ChainConfig(
        ...
        uniswap_v3_router=addr("0xE592427A0AEce92De3Edee1F18E0157C05861564"),
        uniswap_v3_factory=addr("0x1F98431c8aD98523631AE4a59f267346ea31F984"),
        aave_v3_pool=addr("0x794a61358D6845594F94dc1DB02A252b5b4814aD"),
    ...
    "base": ChainConfig(
        ...
        uniswap_v3_router=addr("0x2626664c2603336E57B271c5C0b26F421741e481"),
        uniswap_v3_factory=addr("0x33128a8fC17869897dcE68Ed026d694621f6FDfD"),
        aave_v3_pool=addr("0xA238Dd80C259a72e81d7e4664a9801593F98d1c5"),
    ...
    "polygon": ChainConfig(
        ...
        native_token="MATIC",
        multicall3=addr("0xcA11bde05977b3631167028862bE2a173976CA11"),
        weth=addr("0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270"),  # WMATIC
        block_time=2.0,
    ...
    "bsc": ChainConfig(
        ...
        native_token="BNB",
        multicall3=addr("0xcA11bde05977b3631167028862bE2a173976CA11"),
        weth=addr("0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c"),  # WBNB
        block_time=3.0,
